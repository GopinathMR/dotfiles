...
# more details at https://www.youtube.com/watch?v=mmqDYw9C30I
eval "$(fzf --zsh)"

# easy alias integrating nvim and fzf . ref : https://www.youtube.com/watch?v=oTNRvnQLLLs
alias nvz='nvim $(fzf -m --preview="bat --color=always --style=header,grid --line-range :500 {}")'
...
source ~/github/env-setup/fzf-git.sh/fzf-git.sh
